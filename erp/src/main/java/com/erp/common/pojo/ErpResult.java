...
//    }
    ...
    /**
     * 将json结果集转化为ErpResult对象
     * 
     * @param jsonData json数据
     * @param clazz ErpResult中的object类型
     * @return
     */
    public static ErpResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, ErpResult.class);
            }
     ...
     * @return
     */
    public static ErpResult format(String json) {
        try {
            return MAPPER.readValue(json, ErpResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static ErpResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
